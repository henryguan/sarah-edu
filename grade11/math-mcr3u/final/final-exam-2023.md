...
1. For \(\cos(A) = -\frac{2}{3}\), where \(0^{\circ} \leq A \leq 360^{\circ}\),
...
2. (a) State the pointwise formula for the transformation from the parent function in 4(b) to \(y = 2 \times 3^{-2(x+1)} - 3\) and use it with at least 3 key points.  
    \((x, y)\)
...
3. (a) State the pointwise formula for the transformation from \(y = \cos(x)\) to \(y = -3 \cos(10(x+9)) + 2\), and use it with at least 3 key points of \(y = \cos(x)\).  
    \((x, y)\)
